			...
			<?php foreach ($this->lists as $list): ?>
				...
				<div class="list mx-1 align-self-start" id="list--<?php echo $list['id']; ?>">
					...
					<div class="list-header d-flex m-2" id="list-header--<?php echo $list['id']; ?>">
						<input type="text" class="list-title" id="list-title--<?php echo $list['id']; ?>" value="<?php echo $list['title']; ?>">
						<div class="dropdown p-1">
							<span class="" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="fa fa-bars"></i>
							</span>
							<div class="dropdown-menu">
								<a class="dropdown-item list-edit" id="list-edit--<?php echo $list['id']; ?>">Edit</a>
								<a class="dropdown-item list-delete" id="list-delete--<?php echo $list['id']; ?>">Delete</a>
							</div>
						</div>
					</div>
						...
						<?php foreach ($list['cards'] as $card): ?>
							...
							<div class="d-flex m-2 _card" id="_card--<?php echo $card['id']; ?>">
								...
								<div class="dropdown p-1">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item edit-card" data-toggle="modal" data-target="#modal" id="edit-card--<?php echo $card['id']; ?>">Edit</a>
